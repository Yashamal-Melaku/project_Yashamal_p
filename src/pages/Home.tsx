      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600">
              Professional collaborations and client partnerships
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                role: "Property Management System Developer",
                description: "Developed comprehensive asset management platform",
              ...
              },
              {
                ...
                description: "Built full-featured online shopping mobile application",
              ...
              },
              {
                ...
                description: "Educational programming content reaching 1000+ students",
              ...
              },
              {
                ...
                description: "Built comprehensive student records management system",
              ...
              >
                <div className="relative h-40 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    <div className="text-sm font-medium bg-orange-500 px-2 py-1 rounded">
                      {company.period}
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
            {[
              {
                name: "Haramaya University",
                logo: "https://images.pexels.com/photos/267885/pexels-photo-267885.jpeg?auto=compress&cs=tinysrgb&w=200&h=100"
              },
              {
                name: "Microsoft",
              ...
              {
                name: "Google",
                logo: "https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=200&h=100"
              },
              {
                name: "Amazon",
                logo: "https://images.pexels.com/photos/4482900/pexels-photo-4482900.jpeg?auto=compress&cs=tinysrgb&w=200&h=100"
              },
              {
                name: "Meta",
              ...
              <motion.div
                key={index}
                className="flex flex-col items-center p-6 bg-gray-50 rounded-xl hover:bg-white hover:shadow-lg transition-all duration-300 group"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                viewport={{ once: true }}
                whileHover={{ y: -5 }}
              >
                <div className="w-16 h-16 mb-4 rounded-lg overflow-hidden bg-white shadow-md group-hover:shadow-lg transition-shadow duration-300">
                  <img 
                    src={company.logo} 
                ...
                <h3 className="text-sm font-semibold text-gray-900 text-center group-hover:text-orange-600 transition-colors duration-300">
                  {company.name}
                </h3>
              </motion.div>
            ))}
